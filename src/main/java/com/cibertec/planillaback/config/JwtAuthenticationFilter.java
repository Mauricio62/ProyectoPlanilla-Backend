package com.cibertec.planillaback.config;

import com.cibertec.planillaback.Service.Impl.UserDetailsServiceImpl;
import com.cibertec.planillaback.Utils.JwtUtil;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    private String parseJwt(HttpServletRequest request) {
        ...
        // 4. Buscar en parámetros de query 
        if (headerAuth == null) {
            headerAuth = request.getParameter("token");
        }

        // 5. Buscar en atributos de request 
        if (headerAuth == null) {
